                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBoxID" runat="server" placeholder="ID"></asp:TextBox>
                                        <asp:Button class="btn btn-primary mx-1" ID="BtnGo" runat="server" Text="Go" OnClick="BtnGo_Click" />
                                    </div>
                                </div>
                            </div>
